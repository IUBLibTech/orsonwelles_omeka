...
{
    protected $_hooks = array('public_head','install','uninstall','initialize','video_items_show');
    ...
    {
        echo queue_css_file("mediaelementplayer"); 
        echo queue_css_file("custom");
        echo queue_css_file("jquery-ui");
        //echo queue_css_file("bootstrap");
        echo queue_css_file("vidStyle");
        echo queue_css_file("quality");
		echo js_tag('video');
...
<?php
	...
	//added next two functions from VideoStream as a test
